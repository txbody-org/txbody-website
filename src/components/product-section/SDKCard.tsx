const SDKCard = (sdk: { name: string; description: string }) => {
  return (
    <div className="flex flex-col gap-2 md:gap-6 text-center border border-[#3C4947] p-4 md:p-12 rounded-xs backdrop-blur-2xl  bg-[linear-gradient(124.2deg,rgba(0,163,146,0.05)_29.77%,rgba(255,255,255,0.0005)_75.14%)]">
